...
interface UpdateProps {
  oldData?: API.App;
  onCancel: () => void;
  onSubmit: (values: API.AppEditRequest) => Promise<void>;
  visible: boolean;
}
 ...
 * @constructor
 */
const EditAppModal: React.FC<UpdateProps> = (props) => {
  ...
  return (
    <Modal
      ...
      footer
    >
      <ProForm<API.AppEditRequest>
        onFinish={async (values: API.AppEditRequest) => {
